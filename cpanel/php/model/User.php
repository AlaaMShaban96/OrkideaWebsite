...
class User {
  ...
  private function insert($conn)
  {
      ...
      $sql = "INSERT INTO users (name , email , password,state)
      VALUES ('".$this->name."', '".$this->email."', '".$this->password."', '".$this->state."')";
  ...
  private  function updateUser($conn)
  {
    ...
    $sql = "UPDATE users SET name=' $this->name' , email=' $this->email' , password=' $this->password', state=' $this->state' WHERE id=$this->id";
